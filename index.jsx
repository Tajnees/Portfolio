...
const projects = [
  ...
  },
  {
    ...
    title: "Protech Engineering – EPCC Website",
    role: "Full Stack Developer",
    description: "A corporate site for an EPCC firm delivering electrical construction, installation, testing, commissioning, and solar EPCC services for power plants, grid stations, and industry across Pakistan, with a projects showcase and client roster.",
  ...
  {
    id: "teamio",
    title: "Teamio – HR Software Platform",
    role: "Full Stack Developer",
    description: "An all-in-one HR platform automating payroll, onboarding, attendance, and compliance, with workforce analytics, approval workflows, and support for teams scaling from 10 to 10,000 employees.",
    impact: "100+ Active Companies, $200K+ Payroll Processed",
    url: "https://www.teamio.io/",
    tech: ["Next.js", "SaaS", "Payroll"],
    image: "/projects/teamio.png",
  },
  {
    id: "llfgf",
    title: "The Light and Life Full Gospel Fellowship – Church Website",
    role: "Full Stack Developer",
    description: "A church website with service schedules, upcoming events, an audio library, and online donations, built to keep the congregation connected and support giving from anywhere.",
    impact: "Online Giving + Event Updates",
    url: "https://www.llfgf.org/",
    tech: ["Next.js", "Donations", "CMS"],
    image: "/projects/llfgf.png",
  },
  {
    id: "pixara-ai",
    title: "Pixara AI – Content Creation Platform",
    role: "Contributor",
    description: "An AI content creation platform bringing together top image and video models, Kling, Veo, Midjourney, and more, plus Ara, a built in design agent, into one place so creators can generate video, image, and ad content from a single prompt.",
    impact: "Multi-Model AI Content Platform",
    url: "https://www.pixara.ai/",
    tech: ["AI Platform", "Multimodal Models", "MCP"],
    image: "/projects/pixara.png",
  },
];
