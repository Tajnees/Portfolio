...
const projects = [
  {
    ...
    description:
      "Backend APIs, reporting, and performant React frontend optimized for analytics and high concurrency.",
  ...
  },
  {
    ...
    description:
      "AI-powered customer support automation with ChatGPT integration and real-time dashboards.",
    url: "https://app.sababa.global/login",
    tech: ["Vue 3", "Node", "WebSockets", "Azure"],
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300">
      ...
      <header className="backdrop-blur-sm bg-white/60 dark:bg-gray-800/60 border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-extrabold tracking-tight">Tajnees Qamar</h1>
            <p className="text-sm text-gray-600 dark:text-gray-300">Senior Full Stack Developer — MERN • Next • DevOps</p>
          </div>
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        <section className="grid md:grid-cols-3 gap-8 items-center">
          ...
          >
            <h2 className="text-4xl font-extrabold leading-tight">Senior Full Stack Developer</h2>
            <p className="mt-3 text-gray-600 dark:text-gray-300 max-w-xl">
              I build scalable web applications, microservices, and production-ready CI/CD pipelines. I focus on reliability, performance,
              and developer experience.
            </p>

            <div className="mt-6 flex flex-wrap gap-2">
              <span className="px-3 py-1 rounded-full bg-indigo-100 text-indigo-700 font-semibold">Next.js</span>
              <span className="px-3 py-1 rounded-full bg-indigo-100 text-indigo-700 font-semibold">Node.js</span>
              <span className="px-3 py-1 rounded-full bg-indigo-100 text-indigo-700 font-semibold">Docker</span>
              <span className="px-3 py-1 rounded-full bg-indigo-100 text-indigo-700 font-semibold">AWS</span>
            </div>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="text-sm text-gray-500 dark:text-gray-400">Senior Full Stack Developer</div>
              </div>
            </div>
        ...
        <section className="mt-12">
              ...
              >
                <div className="relative h-40 bg-gradient-to-br from-gray-100 to-gray-50 dark:from-gray-800 dark:to-gray-700">
                  ...
                  {p.image ? (
                    ...
                    <div className="h-40 w-full flex items-center justify-center text-sm text-gray-400">No image</div>
                  )}
                </div>
          ...
          {filtered.length === 0 && (
            <div className="mt-8 text-center text-gray-500">No projects match your search.</div>
          )}
        </section>

        <section className="mt-12">
          <motion.h3 initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-2xl font-bold">
            Skills & Tools
          </motion.h3>

          <motion.div className="mt-4 grid grid-cols-2 sm:grid-cols-4 gap-3">
            {["JavaScript", "React", "Next.js", "Node.js", "Docker", "Kubernetes", "AWS", "Postgres"].map(
              (s) => (
                <div key={s} className="rounded-md px-3 py-2 bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 text-center">
                  {s}
                </div>
              )
            )}
        ...
        <section className="mt-12 mb-24">
          ...
          <div className="mt-4 text-sm text-gray-600 dark:text-gray-300">
            <p>Email: <a className="text-blue-500" href="mailto:tajneesqamar123@gmail.com">tajneesqamar123@gmail.com</a></p>
            <p className="mt-2">LinkedIn: <a className="text-blue-500" href="https://linkedin.com/in/tajnees-qamar-47138212a" target="_blank" rel="noreferrer">Profile</a></p>
          </div>
        </section>
      </main>

      <footer className="border-t border-gray-200 dark:border-gray-700 py-6">
        <div className="max-w-6xl mx-auto px-6 text-center text-sm text-gray-500">© {new Date().getFullYear()} Tajnees Qamar · Built with Next.js</div>
      </footer>
    </div>
  );
}
